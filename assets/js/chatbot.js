...
const steps = [
  {
    ...
    tr: { question: 'Ekibinizle birlikte ulaşmaya çalıştığınız hedef neydi?', placeholder: 'örn., Çeyreklik raporu Cuma gününe kadar tamamlamak...' },
  ...
  },
  {
    ...
    tr: { question: 'Bu hedef ne kadar acildi? Tehlikede olan ne vardı?', placeholder: 'örn., Yüksek aciliyet — müşteri son tarihi yaklaşıyordu...' },
  ...
  },
  {
    ...
    tr: { question: 'Ekibinizi motive etmek için hangi stratejiyi kullandınız?', placeholder: 'örn., Önemini açıklamak için bir ekip toplantısı düzenledim ve net roller atadım...' },
  ...
  },
  {
    ...
    tr: { question: 'Bu hedefi ekip için faydalı olarak nasıl çerçevelendirdiniz?', placeholder: 'örn., Bunu tamamlamanın bir sonraki çeyrekte herkese daha fazla özerklik vereceğini açıkladım...' },
  ...
  },
  {
    ...
    tr: { question: '1-10 arası bir ölçekte, ekibinizin çabasını ne kadar etkili bir şekilde motive ettiniz?' },
  ...
  },
  {
    ...
    tr: { question: 'Temel liderlik değerleriniz nelerdir?', placeholder: 'örn., Dürüstlük, iş birliği, büyüme, şeffaflık...' },
  ...
  },
  {
    ...
    tr: { question: 'Liderlik vizyonunuz nedir?', placeholder: 'örn., Profesyonel olarak büyürken mükemmel sonuçlar üreten bir ekip oluşturmak...' },
  ...
  },
  {
    ...
    tr: { question: 'Sonuç ne oldu? Hedefe ulaşıldı mı?', placeholder: 'örn., Raporu tamamladık ama son tarihi bir gün kaçırdık...' },
  ...
  },
  {
    ...
    tr: { question: 'Herhangi bir noktada sert veya kararlı olmanız gerekti mi? Eğer öyleyse, ne olduğunu açıklayın.', placeholder: 'örn., İlgisiz olan ve son tarihleri kaçıran bir ekip üyesine doğrudan hitap etmem gerekti...' },
...
class LeadershipCoach {
  ...
  t(key) {
    const labels = {
      ...
      tr: {
        welcome: "Hoş geldiniz! Ben YZ Liderlik Koçunuzum. Size yakın tarihli bir liderlik deneyiminiz hakkında birkaç soru soracağım, ardından SFGAL modeline dayalı kişiselleştirilmiş geri bildirim sunacağım.",
        start: 'Analize Başla',
        next: 'Sonraki',
        submit: 'Analizimi Al',
        thinking: 'Liderlik deneyiminiz analiz ediliyor...',
        restart: 'Yeni Analiz Başlat',
